---
name: BGEU
fullname: Branch if Greater or Equal Unsigned
inst: bgeu
format: "bgeu rs1, rs2, offset"
description: Branches to `PC + offset` if `rs1` is greater than or equal to `rs2` (unsigned comparison)
encoding: B
opcode: "1100011"
funct3: "0x7"
funct7: ""
...
notes:
  - "`>=u` means unsigned greater-or-equal comparison (treats values as positive integers, where 0xFFFFFFFF is the largest value)"
